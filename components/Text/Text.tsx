...
export const Text: React.FC<TextProps> = ({ ...restProps }) => {
  const mappedProps = {};
  // TODO: Make ellipsis
  return <KittenText {...restProps} {...mappedProps} />;
};

export const TitleLarge: React.FC<TextProps> = (props) => (
  <Text {...props} category="h3" />
);
export const TitleSmall: React.FC<TextProps> = (props) => (
